...
const OVERVIEW = [
  {
    ...
    body: 'Twedot Credits are the in-app currency used to boost your posts. 1 Twedot Credit = ₦1.5, and they only ever spend on boosting — nothing else on Twedot costs Credits.',
  },
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" width="22" height="22">
